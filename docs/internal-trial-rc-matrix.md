...
| Documentation | `docs/cli.md`, `docs/mcp-server.md`, and `docs/trial-runbook.md` match current commands and tools | [ ] | Note whether worker qualification used CLI, MCP, or both |
